...
class ManagerAssociationsControllerTest < ActionController::TestCase
  ...
  test "should create manager_association" do
    assert_difference('ManagerAssociation.count') do
      post :create, manager_association: { active: @manager_association.active, employee_id: @manager_association.employee_id, manager_id: @manager_association.manager_id }
    end
  ...
  test "should update manager_association" do
    patch :update, id: @manager_association, manager_association: { active: @manager_association.active, employee_id: @manager_association.employee_id, manager_id: @manager_association.manager_id }
    assert_redirected_to manager_association_path(assigns(:manager_association))
  end
